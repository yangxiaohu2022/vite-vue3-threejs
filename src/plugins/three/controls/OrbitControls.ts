...
export class OrbitControls<T extends OrthographicCamera | PerspectiveCamera> extends EventDispatcher {
  object: T;
  ...
  reset: () => void;
  dispose: () => void;
  constructor(object: T, domElement: HTMLElement | Document) {
    super();
    ...
    const pointers: any[] = [];
    const pointerPositions: { [prop: string]: Vector2 } = {};
    ...
    function trackPointer(event: PointerEvent) {
      let position: Vector2 | undefined = pointerPositions[event.pointerId];
...
export class MapControls<T extends OrthographicCamera | PerspectiveCamera> extends OrbitControls<T> {
  constructor(object: T, domElement: HTMLElement | Document) {
